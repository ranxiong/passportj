...
import core.util.generated.random.StringRandom;
...
public class ImageCaptcha extends AbstractCaptcha implements ICaptcha {
    ...
    private String _generated(CAPTCHA_TYPE type, byte size) {
